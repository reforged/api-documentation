  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 dark:border-white/5 sm:flex-row">
      <p className="text-xs text-zinc-600 dark:text-zinc-400">
        &copy; Copyright <a href="https://reforged.fr" className="underline font-semibold">Reforged</a> {new Date().getFullYear()}. Tout droits réservés.
      </p>
      <div className="flex gap-4">
        <SocialLink href="https://github.com/reforged" target={"_blank"} icon={GitHubIcon}>
          Follow us on GitHub
        </SocialLink>
